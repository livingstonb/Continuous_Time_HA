classdef Grid < handle
	...
	methods
	    ...
	    function create_agrids(obj, grid_vec)
	    	...
	    	if nargin == 1
				grid_vec = EconToolsML.GridConstruction.create_positive_asset_grid(obj.p.amax,...
	    ...
	    function create_bgrids(obj, bgrid_vec)
	    	...
	    	if nargin == 1
				bgridpos = EconToolsML.GridConstruction.create_positive_asset_grid(obj.p.bmax,...
					obj.p.b_gcurv_pos, obj.nb_pos, 'term1_curv', obj.p.bgrid_term1_curv,...
					'term1_wt', obj.p.bgrid_term1_weight);

				if obj.nb_neg > 0
					bgridneg = EconToolsML.GridConstruction.create_negative_asset_grid(obj.p.bmin,...
