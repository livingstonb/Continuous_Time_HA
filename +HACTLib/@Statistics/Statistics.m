classdef Statistics < handle
	...
	methods
		...
		function add_params(obj)
			obj.params.nb = obj.sfill(obj.p.nb,...
				'nb, no. of points on liquid grid');
			obj.params.na = obj.sfill(obj.p.na,...
				'na, no. of points on illiquid grid', 2);
			obj.params.b_curv = obj.sfill(obj.p.b_gcurv_pos,...
				'Liquid grid curvature', 2);
			obj.params.a_curv = obj.sfill(obj.p.a_gcurv,...
